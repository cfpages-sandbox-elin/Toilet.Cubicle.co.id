---
article_id: TCB-11-04
title: "Functional Test Pintu dan Hardware Cubicle"
slug: "functional-test-pintu-dan-hardware-cubicle"
description: "Mengatur urutan pemasangan, alignment, operasi pintu, seal, punch list, cleaning, dan serah terima."
status: outline
publication_date: "2026-03-20"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TCB-11
primary_intent: "Menguji swing, latch, indicator, release, clearance, dan repeat operation."
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/functional-test-pintu-dan-hardware-cubicle.html"
...
# Functional Test Pintu dan Hardware Cubicle

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Functional Test Pintu dan Hardware Cubicle”
- **Reader and situation:** Mengatur urutan pemasangan, alignment, operasi pintu, seal, punch list, cleaning, dan serah terima.
- **Reader outcome:** Mengatur urutan pemasangan, alignment, operasi pintu, seal, punch list, cleaning, dan serah terima.
- **Primary intent:** Menguji swing, latch, indicator, release, clearance, dan repeat operation.
...
- **Scope boundary:** Tidak menjadi certification; accessible hardware dimiliki TCB-12.
- **Final public route:** `/artikel/functional-test-pintu-dan-hardware-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Functional Test Pintu dan Hardware Cubicle**.
...
- `TCB-11-02` → `/artikel/penyimpanan-panel-dan-hardware-cubicle.html` — Penyimpanan Panel dan Hardware sebelum Instalasi
- `TCB-11-03` → `/artikel/checklist-alignment-dan-fit-cubicle.html` — Checklist Alignment dan Fit saat Pemasangan
- `TCB-11-05` → `/artikel/final-cleaning-dan-protection-cubicle.html` — Final Cleaning dan Protection setelah Instalasi
- `TCB-11-06` → `/artikel/punch-list-dan-serah-terima-cubicle.html` — Punch List dan Serah Terima Toilet Cubicle
...
- **Tie back to this article:** Keep the explanation specific to “Functional Test Pintu dan Hardware Cubicle”.
