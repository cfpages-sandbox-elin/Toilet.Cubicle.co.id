---
article_id: TCB-10-04
title: "Koordinasi Finished Floor Level untuk Cubicle"
slug: "koordinasi-finished-floor-level-cubicle"
description: "Mengumpulkan data lapangan, memeriksa opening/substrate, menyusun module schedule, dan mereview shop drawing."
status: outline
publication_date: "2026-02-23"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TCB-10
primary_intent: "Menghubungkan slope, drain, door clearance, support, dan datum."
reader_community: "Cubicle.co.id"
reader_address: "Teman Cubicle.co.id"
final_route: "/artikel/koordinasi-finished-floor-level-cubicle.html"
...
# Koordinasi Finished Floor Level untuk Cubicle

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Koordinasi Finished Floor Level untuk Cubicle”
- **Reader and situation:** Mengumpulkan data lapangan, memeriksa opening/substrate, menyusun module schedule, dan mereview shop drawing.
- **Reader outcome:** Mengumpulkan data lapangan, memeriksa opening/substrate, menyusun module schedule, dan mereview shop drawing.
- **Primary intent:** Menghubungkan slope, drain, door clearance, support, dan datum.
...
- **Scope boundary:** Interface wet area; floor design dimiliki trade terkait.
- **Final public route:** `/artikel/koordinasi-finished-floor-level-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Koordinasi Finished Floor Level untuk Cubicle**.
...
- `TCB-10-02` → `/artikel/mengukur-opening-dan-module-cubicle.html` — Cara Mengukur Opening dan Module Cubicle
- `TCB-10-03` → `/artikel/mencatat-substrate-dan-concealed-service.html` — Mencatat Substrate dan Concealed Service saat Survey
- `TCB-10-05` → `/artikel/membuat-module-dan-hardware-schedule-cubicle.html` — Cara Membuat Module dan Hardware Schedule
- `TCB-10-06` → `/artikel/checklist-review-shop-drawing-cubicle.html` — Checklist Review Shop Drawing Toilet Cubicle
...
- **Tie back to this article:** Keep the explanation specific to “Koordinasi Finished Floor Level untuk Cubicle”.
