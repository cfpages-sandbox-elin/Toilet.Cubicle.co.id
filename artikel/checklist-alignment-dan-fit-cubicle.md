---
article_id: TCB-11-03
title: "Checklist Alignment dan Fit saat Pemasangan"
slug: "checklist-alignment-dan-fit-cubicle"
...
date_modified: null
parent_topic: TCB-11
primary_intent: "Memeriksa plumb, level, module, gaps, joints, dan support."
reader_community: "Cubicle.co.id"
reader_address: "Kawan Cubicle.co.id"
final_route: "/artikel/checklist-alignment-dan-fit-cubicle.html"
...
# Checklist Alignment dan Fit saat Pemasangan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Checklist Alignment dan Fit saat Pemasangan”
...
- **Primary intent:** Memeriksa plumb, level, module, gaps, joints, dan support.
...
- **Scope boundary:** QC geometry; tolerance exact mengikuti approved drawing/system.
- **Final public route:** `/artikel/checklist-alignment-dan-fit-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Checklist Alignment dan Fit saat Pemasangan**.
...
- `TCB-11-01` → `/artikel/urutan-instalasi-toilet-cubicle.html` — Urutan Instalasi Toilet Cubicle
- `TCB-11-02` → `/artikel/penyimpanan-panel-dan-hardware-cubicle.html` — Penyimpanan Panel dan Hardware sebelum Instalasi
- `TCB-11-04` → `/artikel/functional-test-pintu-dan-hardware-cubicle.html` — Functional Test Pintu dan Hardware Cubicle
...
- **Tie back to this article:** Keep the explanation specific to “Checklist Alignment dan Fit saat Pemasangan”.
