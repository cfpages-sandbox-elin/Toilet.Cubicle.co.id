---
article_id: TCB-09-04
title: "Signage dan Wayfinding pada Area Cubicle"
slug: "signage-dan-wayfinding-area-cubicle"
...
date_modified: null
parent_topic: TCB-09
primary_intent: "Menentukan identifier, status, direction, contrast, dan placement."
reader_community: "Cubicle.co.id"
reader_address: "Kawan Cubicle.co.id"
final_route: "/artikel/signage-dan-wayfinding-area-cubicle.html"
...
# Signage dan Wayfinding pada Area Cubicle

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Signage dan Wayfinding pada Area Cubicle”
...
- **Primary intent:** Menentukan identifier, status, direction, contrast, dan placement.
...
- **Scope boundary:** Accessibility signage dimiliki TCB-12-04 dan wajib ikut code proyek.
- **Final public route:** `/artikel/signage-dan-wayfinding-area-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Signage dan Wayfinding pada Area Cubicle**.
...
- `TCB-09-02` → `/artikel/mengelola-gap-privasi-cubicle.html` — Mengelola Gap untuk Privasi dan Operasi Pintu
- `TCB-09-03` → `/artikel/review-sightline-entrance-toilet.html` — Review Sightline dari Entrance Toilet
- `TCB-09-05` → `/artikel/menggunakan-mockup-desain-custom-cubicle.html` — Menggunakan Mockup untuk Desain Custom Cubicle
- `TCB-09-06` → `/artikel/desain-cubicle-untuk-area-abuse-tinggi.html` — Desain Cubicle untuk Area dengan Risiko Abuse Tinggi
...
- **Tie back to this article:** Keep the explanation specific to “Signage dan Wayfinding pada Area Cubicle”.
