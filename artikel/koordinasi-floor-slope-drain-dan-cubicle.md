---
article_id: TCB-05-03
title: "Koordinasi Floor Slope dan Drain dengan Cubicle"
slug: "koordinasi-floor-slope-drain-dan-cubicle"
...
date_modified: null
parent_topic: TCB-05
primary_intent: "Mencegah conflict level, ponding, support, dan cleaning path."
reader_community: "Cubicle.co.id"
reader_address: "Sobat Cubicle.co.id"
final_route: "/artikel/koordinasi-floor-slope-drain-dan-cubicle.html"
...
# Koordinasi Floor Slope dan Drain dengan Cubicle

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Koordinasi Floor Slope dan Drain dengan Cubicle”
...
- **Primary intent:** Mencegah conflict level, ponding, support, dan cleaning path.
...
- **Scope boundary:** Interface dengan floor/waterproofing; bukan desain drainage.
- **Final public route:** `/artikel/koordinasi-floor-slope-drain-dan-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Koordinasi Floor Slope dan Drain dengan Cubicle**.
...
- `TCB-05-01` → `/artikel/memetakan-zona-basah-dan-kering-toilet.html` — Memetakan Zona Basah dan Kering di Toilet
- `TCB-05-02` → `/artikel/detail-cubicle-di-area-terkena-air.html` — Detail Cubicle di Area yang Sering Terkena Air
- `TCB-05-04` → `/artikel/ventilasi-dan-kelembapan-ruang-toilet.html` — Ventilasi dan Kelembapan pada Ruang Toilet Cubicle
...
- **Tie back to this article:** Keep the explanation specific to “Koordinasi Floor Slope dan Drain dengan Cubicle”.
